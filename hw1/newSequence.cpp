...
Sequence::Sequence() // Create sequence of default max size
{
...
Sequence::Sequence(int size)  //create sequence of custom size
{
	m_maxSize = size;
	m_size = 0;
...
{
	m_maxSize = seq.m_maxSize;
	m_size = seq.m_size;
	m_array = new ItemType[m_maxSize];
	for (int i = 0; i < m_size; i++) {
		m_array[i] = seq.m_array[i];
	}
}
